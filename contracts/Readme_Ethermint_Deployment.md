...
https://hub.docker.com/r/HessianNetwork/sonar/
...
)) with just the compiled contract in it. `Dockerfile.testrpc` creates the [HessianNetwork/sonar-testrpc](https://hub.docker.com/r/HessianNetwork/sonar-testrpc) image with the contract pre-deployed on `testrpc`.
